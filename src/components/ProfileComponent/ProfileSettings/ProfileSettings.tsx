  ...
  let content = (
    <div className="profile-settings-component">
        ...
        <form action="submit" onSubmit={(e)=>handleSubmit(e)}>
            ...
            <UploadInput ref={avatarRef} labelName='Avatar'
             onChange={async(e)=>{
             let img= await handleUpload(e);
              dispatch({type:ACTIONS.SET_PHOTO, payload:img as string})
            }} removeImg={()=>handleUpload()} id='avatar' />
            ...
            <Button text='submit' name='submit-bnt' img={sendIco}  type='submit' />
        </form>
